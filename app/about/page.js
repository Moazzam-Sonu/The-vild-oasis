...
export default async function Page() {
  ...
  console.log("the lenth of cabins ",cabins.length)
    return (
      <div className="grid grid-cols-5 gap-x-24 gap-y-32 text-lg items-center">
        ...
        <div className="col-span-2">
          ...
          />
            ...
            {/* in case you ar using the static lopath of the img  */}
        <div className="relative  aspect-square col-span-2">
          <Image
           fill
        //    here you can not use the palacehoder or qulaity due to some reasons
